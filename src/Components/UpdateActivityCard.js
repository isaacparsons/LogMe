...
export default UpdateActivityCard = (props) => {
    var {
        activity_info, 
        activity, 
        updateActivity,
    ...
    var {activity, start_time, end_time} = activity
            ...
            <View style = {styles.time_container}>
                <View style = {styles.time_row}>
                    ...
                    <DateTimePicker
                        ...
                        is24Hour={true}
                        display="inline"
                        onChange={(event, date) => setStartTime(date.toString())}
                        />
                </View>
                <View style = {styles.time_row}>
                    ...
                    <DateTimePicker
                        ...
                        is24Hour={true}
                        display="inline"
                        onChange={(event, date) => setEndTime(date.toString())}
                        />
                </View>
            </View>
